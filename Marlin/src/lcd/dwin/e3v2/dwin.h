...
#define Color_Bg_Blue 0x1125    // Dark blue background color - title
#define Color_Bg_Black 0x0841   // Black background color
#define Color_Bg_Red 0xF00F     // Red background color
#define Popup_Text_Color 0xD6BA // Popup font background color
#define Line_Color 0x3A6A       // Split line color
#define Rectangle_Color 0xFBC0  // orange;  // 0xEE2F  // Blue square cursor color
#define Percent_Color 0xFE29    // Percentage color
#define BarFill_Color 0x800A    // purple; 0x10E4    // Fill color of progress bar
#define Select_Color 0xF223     // red; 0x33BB     // Selected color
// END JV CHANGES -----------------
